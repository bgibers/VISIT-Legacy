...
export class UserService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public userLoginUser(credentials: CredentialsViewModel, observe?: 'body', reportProgress?: boolean): Observable<Blob>;
    public userLoginUser(credentials: CredentialsViewModel, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Blob>>;
    public userLoginUser(credentials: CredentialsViewModel, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Blob>>;
    public userLoginUser(credentials: CredentialsViewModel, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post(`${this.basePath}/User/login`,
            credentials,
            {
                responseType: "blob",
                withCredentials: this.configuration.withCredentials,
